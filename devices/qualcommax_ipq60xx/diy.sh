...
rm -rf package/boot package/firmware/ipq-wifi target/linux/qualcommax package/firmware/ath11k-firmware

git_clone_path 25.12-nss https://github.com/LiBwrt/openwrt-6.x target/linux/qualcommax package/boot package/firmware/ipq-wifi package/firmware/ath11k-firmware
