...
luci-nginx wget-ssl curl autocore htop zram-swap kmod-lib-zstd kmod-tcp-bbr bash openssh-sftp-server block-mount resolveip ds-lite swconfig luci-app-fan luci-app-wifihistory /" include/target.mk
