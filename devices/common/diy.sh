...
sed -i "s/192.168.1.1/10.10.1.1/" package/base-files/files/bin/config_generate
...
luci-app-wizard luci-base luci-compat luci-lib-ipkg luci-lib-fs luci-app-log-viewer luci-app-openclash \
